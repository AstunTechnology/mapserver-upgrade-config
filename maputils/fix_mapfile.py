...
class fix_mapfile:
    ...
    def __init__(self, input_file, output_file="", width=2, tabs=False):
        ...
        self.openings = ['class', 'validation', 'map', 'layer', 'outputformat', 'metadata', 'legend', 'label',
                         'querylayer', 'scalebar', 'web', 'style', 'querymap', 'symbol', 'points', 'pattern',
                         'projection']
                ...
                if sline.startswith('end'):
                    ...
                    if in_meta:
                        ...
                        if len(lines) > 0:
                            ...
                            for line in lines:
                                print(self.generate_indent(indent + 1) + line)
